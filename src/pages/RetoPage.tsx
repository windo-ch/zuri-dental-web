          ...
          <div className="flex flex-col lg:flex-row gap-12 items-start">
            <div className="w-full lg:w-1/3">
              <div className="sticky top-32">
                <div className="bg-dental-50 p-6 rounded-lg border border-dental-100 mb-8">
                  ...
                  />
                  <h2 className="text-2xl font-display font-bold text-dental-800 mb-2">Reto Michel</h2>
                  <p className="text-dental-600 mb-4">{t('retoPage.position')}</p>
            ...
            <div className="w-full lg:w-2/3 prose prose-lg max-w-none animate-on-scroll opacity-0 translate-y-4 transition-all duration-700 delay-300">
              ...
              <ul className="space-y-4">
                <li>{t('retoPage.expertise.item1')}</li>
                <li>{t('retoPage.expertise.item2')}</li>
                <li>{t('retoPage.expertise.item3')}</li>
                <li>{t('retoPage.expertise.item4')}</li>
              </ul>
              
              <h2 className="text-3xl font-display font-semibold text-dental-700 mb-6 mt-16">
                {t('retoPage.education.title')}
              </h2>
              <ul className="space-y-4">
                <li>{t('retoPage.education.item1')}</li>
                <li>{t('retoPage.education.item2')}</li>
                <li>{t('retoPage.education.item3')}</li>
              </ul>
