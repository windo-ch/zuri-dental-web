      ...
      <main className={cn(
        ...
        <div className="container mx-auto max-w-6xl px-4 py-12">
          ...
          <div id="contact" className="mt-20">
            <h2 className="text-3xl font-display font-semibold text-dental-700 mb-8">
              {t('dentistsPage.contact.title')}
            </h2>
            <p className="text-lg text-dental-600 mb-10">
              {t('dentistsPage.contact.subtitle')}
            </p>
            <ContactForm />
          </div>
        </div>
