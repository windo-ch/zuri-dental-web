  ...
  return <footer className="bg-dental-800 text-white pt-16 pb-8">
      <div className="container max-w-6xl mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-10 mb-12">
          <div>
            <div className="mb-6">
              <img src="/lovable-uploads/796794fe-b808-4402-b097-f7a6b0da65d8.png" alt="Pietrobon & Michel Logo" className="h-16 w-auto mb-4" />
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {languages.map(lang => <button key={lang.code} onClick={() => setLanguage(lang.code as 'en' | 'de' | 'it' | 'ru')} className={`px-2 py-1 text-xs rounded transition-colors ${language === lang.code ? 'bg-dental-500 text-white' : 'bg-dental-700 text-dental-200 hover:bg-dental-600'}`}>
                      {lang.label}
                    </button>)}
                </div>
              </div>
