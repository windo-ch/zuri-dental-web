...
const About = () => {
  ...
  return <section id="about" ref={sectionRef} className="section-container">
      ...
      <div className="grid md:grid-cols-2 gap-8 lg:gap-16 mb-16">
        <div className="animate-on-scroll order-2 md:order-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
            {benefits.map((benefit, index) => <div key={index} className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow group">
        ...
        <div className="relative h-80 md:h-auto overflow-hidden rounded-lg shadow-xl animate-on-scroll order-1 md:order-2">
          ...
          <img src="https://images.unsplash.com/photo-1629909615183-141b5a1c0fb0?q=80&w=2069&auto=format&fit=crop" alt="Dental laboratory" className="w-full h-full object-cover transition-transform duration-700 hover:scale-105" />
        </div>
      </div>
          ...
          <div className="text-center md:text-left">
            ...
            <div className="mt-4 pt-4 border-t border-gray-100">
              <div className="flex justify-center md:justify-start space-x-3">
                {['#', '#'].map((_, index) => <a key={index} href="#" className="w-8 h-8 flex items-center justify-center rounded-full bg-dental-50 hover:bg-dental-100 transition-colors">
